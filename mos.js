...
function start_experiment() {
    ...
    */
    ...
    method_paths.push(wav_dir + "set" + set_num + "/method4.list");
    method_paths.push(wav_dir + "set" + set_num + "/method5.list");
    method_paths.push(wav_dir + "set" + set_num + "/method6.list");
    /*
